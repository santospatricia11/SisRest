...
public class ContaServidorResource {
    ...
    public ResponseEntity<ContaServidorResponse> getById(@PathVariable("id") long id) {
    ...
    public ResponseEntity<List<ContaServidorResponse>> getAllConta() {
        try {
            List<ContaServidorResponse> contaServidorReponse = contaServidorService.findAll();
            if (contaServidorReponse.isEmpty()) {
                return new ResponseEntity<>(HttpStatus.NO_CONTENT);
            } else {
                return new ResponseEntity<>(contaServidorReponse, HttpStatus.OK);
            }
        } catch (Exception e) {
    ...
    public ResponseEntity<ContaServidorResponse> update(@PathVariable("id") long id, @RequestBody @Valid ContaServidorRequest dto) {
